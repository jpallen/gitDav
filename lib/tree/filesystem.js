 ...
 * @contructor
 */
function jsDAV_Tree_Filesystem(basePath, author) {
    ...
    this.getNodeForPath = function(path, cbfstree) {
        ...
        Fs.stat(realPath, function(err, stat) {
            ...
            cbfstree(null, stat.isDirectory()
                ? new jsDAV_Git_Directory(realPath, _self.basePath, _self.author)
                : new jsDAV_Git_File(realPath, _self.basePath, _self.author))
        });
    };
